...
Результат продемонстрирован на скриншоте "task4" в директории pictures текущего репозитория
...
Работающий alias ll продемонстрирован на скриншоте "task7_1" в директории pictures текущего репозитория
![alt](pictures/task7_1.png)

Далее работа с автодополнениями продемонстрирована изменением правила автодополнений для команды cd на скриншоте "task7_2" в директории pictures текущего репозитория (автодополнение для cd стало рекомендовать только директории)
